%mem=16000Mb
%NProc=8
%oldchk=gs-uo2cl2phen2.linear.mp2.sp.chk
%chk=gs-uo2cl2phen2.linear.cam-b3lyp.sp.chk
#p CAM-B3LYP/GEN GFInput GFPrint 5D 7F IOP(6/7=3, 4/69=2, 6/10=1) Pseudo=Read
